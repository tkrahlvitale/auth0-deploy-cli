...
export declare class CredentialsClient {
     ...
     */
    list(client_id: string, requestOptions?: CredentialsClient.RequestOptions): core.HttpResponsePromise<Management.ClientCredential[]>;
    private __list;
    /**
     ...
     *     })
     */
    create(client_id: string, request: Management.PostClientCredentialRequestContent, requestOptions?: CredentialsClient.RequestOptions): core.HttpResponsePromise<Management.PostClientCredentialResponseContent>;
    private __create;
    /**
     * Get the details of a client credential.
     *
     ...
     */
    get(client_id: string, credential_id: string, requestOptions?: CredentialsClient.RequestOptions): core.HttpResponsePromise<Management.GetClientCredentialResponseContent>;
    private __get;
    /**
     ...
     */
    delete(client_id: string, credential_id: string, requestOptions?: CredentialsClient.RequestOptions): core.HttpResponsePromise<void>;
    private __delete;
    /**
     ...
     */
    update(client_id: string, credential_id: string, request?: Management.PatchClientCredentialRequestContent, requestOptions?: CredentialsClient.RequestOptions): core.HttpResponsePromise<Management.PatchClientCredentialResponseContent>;
    private __update;
}
