...
export declare class LogsClient {
     ...
     *     })
     */
    list(request?: Management.ListLogsRequestParameters, requestOptions?: LogsClient.RequestOptions): Promise<core.Page<Management.Log, Management.ListLogOffsetPaginatedResponseContent>>;
    /**
     ...
     */
    get(id: string, requestOptions?: LogsClient.RequestOptions): core.HttpResponsePromise<Management.GetLogResponseContent>;
    private __get;
}
