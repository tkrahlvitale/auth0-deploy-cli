...
const Client_js_3 = require("../resources/discoveryDomains/client/Client.js");
const Client_js_4 = require("../resources/enabledConnections/client/Client.js");
const Client_js_5 = require("../resources/invitations/client/Client.js");
const Client_js_6 = require("../resources/members/client/Client.js");
class OrganizationsClient {
    ...
    get connections() {
        var _a;
        return ((_a = this._connections) !== null && _a !== void 0 ? _a : (this._connections = new Client_js_2.ConnectionsClient(this._options)));
    }
    get discoveryDomains() {
        var _a;
        return ((_a = this._discoveryDomains) !== null && _a !== void 0 ? _a : (this._discoveryDomains = new Client_js_3.DiscoveryDomainsClient(this._options)));
    }
    get enabledConnections() {
        var _a;
        return ((_a = this._enabledConnections) !== null && _a !== void 0 ? _a : (this._enabledConnections = new Client_js_4.EnabledConnectionsClient(this._options)));
    }
    get invitations() {
        var _a;
        return ((_a = this._invitations) !== null && _a !== void 0 ? _a : (this._invitations = new Client_js_5.InvitationsClient(this._options)));
    }
    get members() {
        var _a;
        return ((_a = this._members) !== null && _a !== void 0 ? _a : (this._members = new Client_js_6.MembersClient(this._options)));
    }
    /**
