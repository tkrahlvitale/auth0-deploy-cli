...
export declare class MembersClient {
     ...
     *     })
     */
    list(id: string, request?: Management.ListOrganizationMembersRequestParameters, requestOptions?: MembersClient.RequestOptions): Promise<core.Page<Management.OrganizationMember, Management.ListOrganizationMembersPaginatedResponseContent>>;
    /**
     ...
     *     })
     */
    create(id: string, request: Management.CreateOrganizationMemberRequestContent, requestOptions?: MembersClient.RequestOptions): core.HttpResponsePromise<void>;
    private __create;
    /**
     * @param {string} id - Organization identifier.
     ...
     *     })
     */
    delete(id: string, request: Management.DeleteOrganizationMembersRequestContent, requestOptions?: MembersClient.RequestOptions): core.HttpResponsePromise<void>;
    private __delete;
}
