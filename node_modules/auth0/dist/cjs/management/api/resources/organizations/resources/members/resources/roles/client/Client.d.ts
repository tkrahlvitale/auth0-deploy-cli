...
export declare class RolesClient {
     ...
     *     })
     */
    list(id: string, user_id: string, request?: Management.ListOrganizationMemberRolesRequestParameters, requestOptions?: RolesClient.RequestOptions): Promise<core.Page<Management.Role, Management.ListOrganizationMemberRolesOffsetPaginatedResponseContent>>;
    /**
     ...
     *     })
     */
    assign(id: string, user_id: string, request: Management.AssignOrganizationMemberRolesRequestContent, requestOptions?: RolesClient.RequestOptions): core.HttpResponsePromise<void>;
    private __assign;
    /**
     ...
     *     })
     */
    delete(id: string, user_id: string, request: Management.DeleteOrganizationMemberRolesRequestContent, requestOptions?: RolesClient.RequestOptions): core.HttpResponsePromise<void>;
    private __delete;
}
