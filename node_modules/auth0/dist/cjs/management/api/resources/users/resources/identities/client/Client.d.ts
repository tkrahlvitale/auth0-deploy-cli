...
export declare class IdentitiesClient {
     ...
     */
    link(id: string, request?: Management.LinkUserIdentityRequestContent, requestOptions?: IdentitiesClient.RequestOptions): core.HttpResponsePromise<Management.UserIdentity[]>;
    private __link;
    /**
     ...
     */
    delete(id: string, provider: Management.UserIdentityProviderEnum, user_id: string, requestOptions?: IdentitiesClient.RequestOptions): core.HttpResponsePromise<Management.DeleteUserIdentityResponseContent>;
    private __delete;
}
