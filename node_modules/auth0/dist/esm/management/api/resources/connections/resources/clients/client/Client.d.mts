...
export declare class ClientsClient {
     ...
     *     })
     */
    get(id: string, request?: Management.GetConnectionEnabledClientsRequestParameters, requestOptions?: ClientsClient.RequestOptions): Promise<core.Page<Management.ConnectionEnabledClient, Management.GetConnectionEnabledClientsResponseContent>>;
    /**
     ...
     *         }])
     */
    update(id: string, request: Management.UpdateEnabledClientConnectionsRequestContent, requestOptions?: ClientsClient.RequestOptions): core.HttpResponsePromise<void>;
    private __update;
}
