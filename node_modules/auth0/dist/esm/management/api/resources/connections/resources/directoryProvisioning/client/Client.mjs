...
export class DirectoryProvisioningClient {
    ...
    listSynchronizedGroups(id_1) {
        return __awaiter(this, arguments, void 0, function* (id, request = {}, requestOptions) {
            const list = core.HttpResponsePromise.interceptFunction((request) => __awaiter(this, void 0, void 0, function* () {
                ...
                return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/connections/{id}/directory-provisioning/synchronized-groups");
            }));
            const dataWithRawResponse = yield list(request).withRawResponse();
            return new core.Page({
                response: dataWithRawResponse.data,
    ...
    __set(id, request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "PUT", "/connections/{id}/directory-provisioning/synchronized-groups");
        });
    }
}
