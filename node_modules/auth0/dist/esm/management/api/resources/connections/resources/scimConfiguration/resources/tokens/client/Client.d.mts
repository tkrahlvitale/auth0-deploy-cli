...
export declare class TokensClient {
     ...
     */
    get(id: string, requestOptions?: TokensClient.RequestOptions): core.HttpResponsePromise<Management.GetScimTokensResponseContent>;
    private __get;
    /**
     ...
     */
    create(id: string, request?: Management.CreateScimTokenRequestContent, requestOptions?: TokensClient.RequestOptions): core.HttpResponsePromise<Management.CreateScimTokenResponseContent>;
    private __create;
    /**
     ...
     */
    delete(id: string, tokenId: string, requestOptions?: TokensClient.RequestOptions): core.HttpResponsePromise<void>;
    private __delete;
}
