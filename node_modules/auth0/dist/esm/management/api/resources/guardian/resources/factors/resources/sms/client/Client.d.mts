...
export declare namespace SmsClient {
    type Options = BaseClientOptions;
    interface RequestOptions extends BaseRequestOptions {
    }
}
export declare class SmsClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<SmsClient.Options>;
    constructor(options: SmsClient.Options);
    /**
     ...
     */
    getTwilioProvider(requestOptions?: SmsClient.RequestOptions): core.HttpResponsePromise<Management.GetGuardianFactorsProviderSmsTwilioResponseContent>;
     ...
     */
    setTwilioProvider(request?: Management.SetGuardianFactorsProviderSmsTwilioRequestContent, requestOptions?: SmsClient.RequestOptions): core.HttpResponsePromise<Management.SetGuardianFactorsProviderSmsTwilioResponseContent>;
     ...
     */
    getSelectedProvider(requestOptions?: SmsClient.RequestOptions): core.HttpResponsePromise<Management.GetGuardianFactorsProviderSmsResponseContent>;
     ...
     *     })
     */
    setProvider(request: Management.SetGuardianFactorsProviderSmsRequestContent, requestOptions?: SmsClient.RequestOptions): core.HttpResponsePromise<Management.SetGuardianFactorsProviderSmsResponseContent>;
     ...
     */
    getTemplates(requestOptions?: SmsClient.RequestOptions): core.HttpResponsePromise<Management.GetGuardianFactorSmsTemplatesResponseContent>;
     ...
     *     })
     */
    setTemplates(request: Management.SetGuardianFactorSmsTemplatesRequestContent, requestOptions?: SmsClient.RequestOptions): core.HttpResponsePromise<Management.SetGuardianFactorSmsTemplatesResponseContent>;
