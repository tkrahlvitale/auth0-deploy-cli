...
export class ConnectionsClient {
    ...
    list(id_1) {
        return __awaiter(this, arguments, void 0, function* (id, request = {}, requestOptions) {
            const list = core.HttpResponsePromise.interceptFunction((request) => __awaiter(this, void 0, void 0, function* () {
                ...
                return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/organizations/{id}/connections");
            }));
    ...
    __create(id, request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/organizations/{id}/connections");
        });
    }
    /**
     * @param {string} id - Organization identifier.
    ...
    __get(id, connection_id, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "GET", "/organizations/{id}/connections/{connection_id}");
        });
    }
    /**
     * @param {string} id - Organization identifier.
    ...
    __delete(id, connection_id, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "DELETE", "/organizations/{id}/connections/{connection_id}");
        });
    }
    /**
     * @param {string} id - Organization identifier.
    ...
    __update(id_1, connection_id_1) {
        return __awaiter(this, arguments, void 0, function* (id, connection_id, request = {}, requestOptions) {
            ...
            return handleNonStatusCodeError(_response.error, _response.rawResponse, "PATCH", "/organizations/{id}/connections/{connection_id}");
        });
    }
}
