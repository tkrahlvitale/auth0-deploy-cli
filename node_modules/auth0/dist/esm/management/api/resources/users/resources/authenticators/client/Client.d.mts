...
export declare namespace AuthenticatorsClient {
    type Options = BaseClientOptions;
    interface RequestOptions extends BaseRequestOptions {
    }
}
export declare class AuthenticatorsClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<AuthenticatorsClient.Options>;
    constructor(options: AuthenticatorsClient.Options);
    /**
     ...
     */
    deleteAll(id: string, requestOptions?: AuthenticatorsClient.RequestOptions): core.HttpResponsePromise<void>;
    private __deleteAll;
}
