...
import { fetcher as coreFetcher } from "./core/index.mjs";
/**
 ...
 * ```
 */
export function withTimeout(seconds) {
    return {
 ...
 * ```
 */
export function withRetries(retries) {
    return {
        maxRetries: retries,
    };
}
 ...
 * ```
 */
export function withAbortSignal(signal) {
    return {
        abortSignal: signal,
    };
}
 ...
 */
export function withCustomDomainHeader(domain, options) {
