...
import { AuthenticationClient } from "../../auth/index.mjs";
...
export class TokenProvider {
    constructor(options) {
        ...
        this.expiresAt = 0;
        this.accessToken = "";
        this.authenticationClient = new AuthenticationClient(Object.assign(Object.assign({}, options), { headers: undefined }));
    }
    getAccessToken() {
