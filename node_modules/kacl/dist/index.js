...
var require_is_fullwidth_code_point2 = __commonJS((exports2, module2) => {
  "use strict";
  var isFullwidthCodePoint = (codePoint) => {
    if (Number.isNaN(codePoint)) {
      return false;
...
var require_sync = __commonJS((exports2) => {
  ...
  function sync_default(start, callback) {
    let dir = import_path.resolve(".", start);
    let tmp, stats = import_fs2.statSync(dir);
    if (!stats.isDirectory()) {
      dir = import_path.dirname(dir);
    }
    while (true) {
      tmp = callback(dir, import_fs2.readdirSync(dir));
      if (tmp)
        return import_path.resolve(dir, tmp);
      dir = import_path.dirname(tmp = dir);
      if (tmp === dir)
        break;
    }
  }
...
var require_ansi_regex3 = __commonJS((exports2, module2) => {
  "use strict";
  module2.exports = ({onlyFirst = false} = {}) => {
    const pattern = [
      "[\\u001B\\u009B][[\\]()#;?]*(?:(?:(?:[a-zA-Z\\d]*(?:;[-a-zA-Z\\d\\/#&.:=?%@~_]*)*)?\\u0007)",
...
var require_strip_ansi3 = __commonJS((exports2, module2) => {
  "use strict";
...
var require_is_fullwidth_code_point3 = __commonJS((exports2, module2) => {
  "use strict";
  var isFullwidthCodePoint = (codePoint) => {
    if (Number.isNaN(codePoint)) {
      return false;
...
var require_string_width3 = __commonJS((exports2, module2) => {
  "use strict";
...
var require_build4 = __commonJS((exports2, module2) => {
  "use strict";
  ...
  function command(yargs2, usage2, validation2, globalMiddleware = [], shim2) {
    ...
    self.runCommand = function runCommand(command2, yargs3, parsed, commandIndex) {
      ...
      if (isCommandBuilderCallback(builder)) {
        ...
        const innerYargs = isYargsInstance(builderOutput) ? builderOutput : yargs3;
      ...
      if (commandHandler.handler && !yargs3._hasOutput()) {
        ...
        yargs3._postProcess(innerArgv, populateDoubleDash);
  ...
  function usage(yargs2, y18n2, shim2) {
    ...
    self.help = function help() {
      ...
      normalizeAliases();
      const base$0 = yargs2.customScriptName ? yargs2.$0 : shim2.path.basename(yargs2.$0);
...
###-end-{{app_name}}-completions-###
`;
  function completion(yargs2, usage2, command2, shim2) {
    const self = {
...
`;
  ...
  function Yargs2(processArgs = [], cwd = shim$1.process.cwd(), parentRequire) {
    const self = {};
    let command$1;
    ...
    self.parse = function parse2(args, shortCircuit, _parseFn) {
  ...
  var cjsPlatformShim = {
    ...
    stringWidth: require_string_width3(),
    y18n: y18n({
...
var require_yargs = __commonJS((exports2, module2) => {
  "use strict";
  var {Yargs: Yargs2, processArgv} = require_build4();
  Argv2(processArgv.hideBin(process.argv));
  module2.exports = Argv2;
  function Argv2(processArgs, cwd) {
  ...
  function singletonify(inst) {
    Object.keys(inst).forEach((key) => {
      if (key === "argv") {
        Argv2.__defineGetter__(key, inst.__lookupGetter__(key));
      } else if (typeof inst[key] === "function") {
        Argv2[key] = inst[key].bind(inst);
      } else {
        Argv2.__defineGetter__("$0", () => {
          return inst.$0;
        });
        Argv2.__defineGetter__("parsed", () => {
          return inst.parsed;
        });
      }
    });
...
// node_modules/keep-a-changelog/node_modules/semver/internal/debug.js
...
// node_modules/keep-a-changelog/node_modules/semver/internal/constants.js
...
// node_modules/keep-a-changelog/node_modules/semver/internal/re.js
...
// node_modules/keep-a-changelog/node_modules/semver/internal/parse-options.js
...
// node_modules/keep-a-changelog/node_modules/semver/internal/identifiers.js
...
// node_modules/keep-a-changelog/node_modules/semver/classes/semver.js
...
// node_modules/keep-a-changelog/src/Change.js
var require_Change = __commonJS((exports2, module2) => {
  var Change = class {
  ...
  module2.exports = Change;
  Change.extractIssues = function(text, issues) {
    return text.replace(/(^|[^\\])\[#(\d+)\](?=[^\(]|$)/g, (matches, start, index) => {
...
// node_modules/keep-a-changelog/src/Release.js
var require_Release = __commonJS((exports2, module2) => {
...
// node_modules/keep-a-changelog/node_modules/semver/functions/compare.js
...
// node_modules/keep-a-changelog/node_modules/semver/functions/eq.js
...
// node_modules/keep-a-changelog/src/Changelog.js
var require_Changelog = __commonJS((exports2, module2) => {
  var Release2 = require_Release();
  var eq = require_eq();
  var Changelog2 = class {
    constructor(title, description = "") {
      this.title = title;
      this.description = description;
      this.head = "HEAD";
    ...
    addRelease(release) {
      if (!(release instanceof Release2)) {
    ...
    toString() {
      ...
      const links = [];
      const compareLinks = [];
      const description = this.description.trim() || `All notable changes to this project will be documented in this file.
...
and this project adheres to [Semantic Versioning](http://semver.org/).`;
      ...
      this.releases.forEach((release) => {
        ...
        release.getLinks(this).forEach((link2) => {
...
// node_modules/keep-a-changelog/src/parser.js
var require_parser = __commonJS((exports2, module2) => {
  var Changelog2 = require_Changelog();
  var Release2 = require_Release();
  var defaultOptions = {
    releaseCreator: (version, date, description) => new Release2(version, date, description)
  };
  module2.exports = function parser2(markdown, options) {
  ...
  function parseTokens(tokens, opts) {
    const changelog = new Changelog2();
    ...
    while (release = getContent(tokens, "h2").toLowerCase()) {
      ...
      if (matches) {
        ...
        const matches2 = release.match(/\[?([^\]]+)\]?\s*-\s*unreleased$/);
        release = matches2 ? opts.releaseCreator(matches2[1]) : opts.releaseCreator();
      } else {
  ...
  function tokenize(markdown) {
    ...
    return tokens.filter((token) => !isEmpty(token[2])).map((token) => {
...
// node_modules/keep-a-changelog/src/index.js
var require_src = __commonJS((exports2, module2) => {
  module2.exports = {
    parser: require_parser(),
    Change: require_Change(),
    Changelog: require_Changelog(),
...
var require_mbcs = __commonJS((exports2, module2) => {
  var util = require("util");
  var Match = require_match();
...
var require_sbcs = __commonJS((exports2, module2) => {
  var util = require("util");
  var Match = require_match();
  ...
  sbcs.prototype.match = function(det) {
    ...
    if (!multiple) {
      var parser2 = new NGramParser(ngrams, this.byteMap());
      var confidence = parser2.parse(det, this.spaceChar);
      return confidence <= 0 ? null : new Match(det, this, confidence);
    }
    ...
    for (var i = ngrams.length - 1; i >= 0; i--) {
      var ngl = ngrams[i];
      var parser2 = new NGramParser(ngl.fNGrams, this.byteMap());
      var confidence = parser2.parse(det, this.spaceChar);
...
var require_iso2022 = __commonJS((exports2, module2) => {
  var util = require("util");
  var Match = require_match();
  function ISO_2022() {
  }
...
var require_chardet = __commonJS((exports2, module2) => {
  var fs = require("fs");
...
var require_os_tmpdir = __commonJS((exports2, module2) => {
  "use strict";
...
var require_CreateFileError = __commonJS((exports2) => {
  "use strict";
  ...
  var CreateFileError2 = function(_super) {
    __extends(CreateFileError3, _super);
    function CreateFileError3(originalError) {
    ...
    return CreateFileError3;
  }(Error);
  exports2.CreateFileError = CreateFileError2;
});

// node_modules/external-editor/main/errors/LaunchEditorError.js
var require_LaunchEditorError = __commonJS((exports2) => {
  "use strict";
  var __extends = exports2 && exports2.__extends || function() {
    var extendStatics = function(d, b) {
      extendStatics = Object.setPrototypeOf || {__proto__: []} instanceof Array && function(d2, b2) {
  ...
  Object.defineProperty(exports2, "__esModule", {value: true});
  var LaunchEditorError2 = function(_super) {
    __extends(LaunchEditorError3, _super);
    function LaunchEditorError3(originalError) {
      var _newTarget = this.constructor;
    ...
    return LaunchEditorError3;
  }(Error);
  exports2.LaunchEditorError = LaunchEditorError2;
});

// node_modules/external-editor/main/errors/ReadFileError.js
var require_ReadFileError = __commonJS((exports2) => {
  "use strict";
  var __extends = exports2 && exports2.__extends || function() {
    var extendStatics = function(d, b) {
      extendStatics = Object.setPrototypeOf || {__proto__: []} instanceof Array && function(d2, b2) {
  ...
  Object.defineProperty(exports2, "__esModule", {value: true});
  var ReadFileError2 = function(_super) {
    __extends(ReadFileError3, _super);
    function ReadFileError3(originalError) {
      var _newTarget = this.constructor;
    ...
    return ReadFileError3;
  }(Error);
  exports2.ReadFileError = ReadFileError2;
});

// node_modules/external-editor/main/errors/RemoveFileError.js
var require_RemoveFileError = __commonJS((exports2) => {
  "use strict";
  var __extends = exports2 && exports2.__extends || function() {
    var extendStatics = function(d, b) {
      extendStatics = Object.setPrototypeOf || {__proto__: []} instanceof Array && function(d2, b2) {
  ...
  Object.defineProperty(exports2, "__esModule", {value: true});
  var RemoveFileError2 = function(_super) {
    __extends(RemoveFileError3, _super);
    function RemoveFileError3(originalError) {
      var _newTarget = this.constructor;
    ...
    return RemoveFileError3;
  }(Error);
  exports2.RemoveFileError = RemoveFileError2;
});
...
var require_main = __commonJS((exports2) => {
  ...
  function edit(text, fileOptions) {
    ...
    var editor = new ExternalEditor2(text, fileOptions);
    editor.run();
    editor.cleanup();
    return editor.text;
  }
  ...
  var ExternalEditor2 = function() {
    function ExternalEditor3(text, fileOptions) {
      if (text === void 0) {
        text = "";
      }
      this.text = "";
    ...
    ExternalEditor3.splitStringBySpace = function(str) {
      var pieces = [];
      var currentString = "";
    ...
    Object.defineProperty(ExternalEditor3.prototype, "temp_file", {
      get: function() {
    ...
    Object.defineProperty(ExternalEditor3.prototype, "last_exit_status", {
      get: function() {
    ...
    ExternalEditor3.prototype.run = function() {
      this.launchEditor();
      this.readTemporaryFile();
      return this.text;
    };
    ExternalEditor3.prototype.runAsync = function(callback) {
      var _this = this;
      try {
    ...
    ExternalEditor3.prototype.cleanup = function() {
      this.removeTemporaryFile();
    };
    ExternalEditor3.prototype.determineEditor = function() {
      ...
      var editorOpts = ExternalEditor3.splitStringBySpace(editor).map(function(piece) {
        return piece.replace("\\ ", " ");
      });
      var bin = editorOpts.shift();
      this.editor = {args: editorOpts, bin};
    };
    ExternalEditor3.prototype.createTemporaryFile = function() {
      try {
    ...
    ExternalEditor3.prototype.readTemporaryFile = function() {
      try {
    ...
    ExternalEditor3.prototype.removeTemporaryFile = function() {
      try {
    ...
    ExternalEditor3.prototype.launchEditor = function() {
      try {
    ...
    ExternalEditor3.prototype.launchEditorAsync = function(callback) {
      var _this = this;
      try {
    ...
    return ExternalEditor3;
  }();
  exports2.ExternalEditor = ExternalEditor2;
});

// src/index.ts
var import_fs = __toModule(require("fs"));
var Url = __toModule(require("url"));
var import_yargs = __toModule(require_yargs());
var import_keep_a_changelog = __toModule(require_src());
var Chalk = __toModule(require_source());
var import_external_editor = __toModule(require_main());
var yargs = import_yargs.default.help().demandCommand().recommendCommands().strict().showHelpOnFail(true);
attachChangeLogHandlers(yargs.command("add", "Add changes to the unreleased version", attachChangeLogHandlers).command("init", "Initialize an empty CHANGELOG.md", {
  filename: {
  ...
  let file;
  try {
    file = await import_fs.promises.open(argv.filename, argv.force ? "w" : "wx");
  } catch (err) {
    console.error(Chalk.red(`\u274C Error while attempting to take an exclusive read on ${argv.filename}:
  ${Chalk.dim(err.message)}`));
    process.exit(1);
  }
  const pkg = await getPackage();
  const changelog = new import_keep_a_changelog.Changelog("Changelog");
  changelog.addRelease(new import_keep_a_changelog.Release());
  changelog.url = pkg.repository.url;
  await file.writeFile(changelog.toString());
  console.error(Chalk.green(`\u2705 Wrote ${argv.filename}`));
  process.exit(0);
}).command("lint", "Check the format of your changelog", (yargs2) => yargs2.epilogue(`Hint: You should consider adding this as your ${Chalk.bold("posttest")} command in package.json.`).options({
  filename: {
    default: "CHANGELOG.md",
    description: "The name of the changelog file to write"
  }
  ...
  process.exit(0);
}).command("prerelease", "Check the requirements for creating a release", (yargs2) => yargs2.epilogue(`Hint: You should consider adding this as your ${Chalk.bold("prerelease")} command in package.json.`).options({
  filename: {
    default: "CHANGELOG.md",
    description: "The name of the changelog file to write"
  }
...
}).command("release", "Create a new release", (yargs2) => yargs2.epilogue(`Hint you should consider adding the following as your ${Chalk.bold("version")} script in package.json: ${Chalk.bold("kacl release && git add CHANGELOG.md")}`).options({
  filename: {
    default: "CHANGELOG.md",
    description: "The name of the changelog file to write"
  }
  ...
  if (!existingRelease) {
    if (!unreleased || unreleased.isEmpty()) {
      console.error(Chalk.red(`\u274C No changes to the Changelog for release in ${argv.filename}`));
      process.exit(1);
    }
    unreleased.setVersion(pkg.version);
    unreleased.date = new Date();
    changelog.addRelease(new import_keep_a_changelog.Release());
    await import_fs.promises.writeFile(argv.filename, changelog.toString());
    console.log(Chalk.green("Released Changelog!"));
  } else if (unreleased && !unreleased.isEmpty()) {
    console.error(Chalk.red("\u274C Release already exists, did you mean to bump your package's version?"));
    process.exit(1);
  } else {
    console.log(Chalk.blue("\u{1F6AB} Changelog is up-to-date, not performing a release"));
    process.exit(2);
  }
})).argv;
function attachChangeLogHandlers(yargs2) {
  for (const type of ["added", "changed", "deprecated", "removed", "fixed", "security"]) {
    yargs2.command(`${type} [change]`, `Insert a ${type} change in the unreleased version.`, (yargs3) => yargs3.epilogue(`Hint: Make sure that you quote your change as a single shell string (ie: kacl add added "Change text"). Note that if no change text is provided you will be prompted to enter such text in your $EDITOR of choice.`).positional("change", {
      type: "string",
      ...
      if (!unreleased) {
        unreleased = new import_keep_a_changelog.Release();
...
async function getChangelog(filename, mode = "r") {
  let file;
  try {
    file = await import_fs.promises.open(filename, mode);
    const text = await file.readFile("utf8");
    const changelog = import_keep_a_changelog.parser(text);
    return changelog;
  } catch (err) {
...
async function getPackage() {
  let pkg;
  try {
    const json = await import_fs.promises.readFile("package.json", "utf8");
    pkg = JSON.parse(json);
  } catch (err) {
...
function getPackageUrl(packageUrl) {
  packageUrl = packageUrl.replace(/^git\+/, "").replace(/^(?:ssh:\/\/(?:git@)?|git@)/, "https://");
  const parsed = Url.parse(packageUrl);
  if (parsed.pathname) {
    parsed.pathname = parsed.pathname.replace(/\/:(?:(\d+):)?/, (match, port) => {
      if (!parsed.port && port) {
        parsed.port = port;
        parsed.host += ":" + port;
      }
...
async function readChangeText(changeKind, text) {
  if (text) {
    return text;
  }
  const editor = new import_external_editor.ExternalEditor(`[//]: # (Add your description for the ${changeKind} change in markdown format below)

`, {postfix: ".md"});
  try {
    const text2 = editor.run();
    if (editor.lastExitStatus !== 0) {
      throw new Error("The editor exited with a non-zero code");
    }
    const trimmedText = text2.replace(/^\[\/\/\].*$/gm, "").trim();
    if (!trimmedText) {
      throw new Error(`No change text was provided, aborting`);
    }
    return trimmedText;
  } catch (err) {
    if (err instanceof import_external_editor.CreateFileError) {
      throw new Error("Failed to create the temporary file");
    } else if (err instanceof import_external_editor.ReadFileError) {
      throw new Error("Failed to read the temporary file");
    } else if (err instanceof import_external_editor.LaunchEditorError) {
    ...
    try {
      ...
      if (err instanceof import_external_editor.RemoveFileError) {
